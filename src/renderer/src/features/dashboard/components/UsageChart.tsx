...
export const UsageChart = memo(
  ({ data, title, period, offset, onPeriodChange, onPrev, onNext, className }: UsageChartProps) => {
    ...
    return (
      <div
        className={`col-span-4 bg-transparent outline-none focus:outline-none usage-chart-container ${className || ''}`}
            ...
            >
              <defs>
                ...
                <linearGradient id="colorTokens" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="5%" stopColor="rgb(var(--violet-500))" stopOpacity={0.2} />
                  <stop offset="95%" stopColor="rgb(var(--violet-500))" stopOpacity={0} />
                </linearGradient>
              </defs>
              <CartesianGrid
                strokeDasharray="3 3"
              ...
              <Tooltip
                ...
                cursor={{ stroke: 'rgb(var(--divider))', strokeWidth: 1 }}
              />
              <Area
                yAxisId="left"
                type="monotone"
                ...
                activeDot={{ r: 5, strokeWidth: 0, fill: 'rgb(var(--primary))' }}
              />
              <Area
                yAxisId="right"
                type="monotone"
