...
exports.webuiRouter = webuiRouter;
...
// ============================================================
function webuiRouter(chatEngine, getInitStatus) {
    ...
    const handleApiChatCompletions = async (req, res) => {
        ...
        const resolvedConversationId = req.body.chat_id || req.body.conversationId || `z-session-${Date.now()}`;
