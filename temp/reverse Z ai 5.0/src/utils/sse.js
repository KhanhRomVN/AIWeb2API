...
exports.createTokenFlusher = createTokenFlusher;
// ============================================================
...
function writeSSEHeaders(res, rateLimiter, usage) {
...
function writeUsageEvent(res, usage, conversationId) {
 ...
 */
function createTokenFlusher(res) {
    let pendingTokens = '';
